...
const create = asyncHandler(async (req: Request, res: Response) => {
  ...
  if (!director) {
    throw new AppError('Director not create', StatusCodes.BAD_REQUEST, 'DIRECTOR_NOT_CREATE');
  }
...
const getById = asyncHandler(async (req: Request, res: Response) => {
  ...
  if (!director) {
    throw new AppError('Director not found', StatusCodes.NOT_FOUND, 'DIRECTOR_NOT_FOUND');
  }
